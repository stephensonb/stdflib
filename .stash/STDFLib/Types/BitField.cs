...
namespace STDFLib2
{
    ...
    {
        public static explicit operator BitField(byte[] buffer)
        {
            return new BitField(buffer);
        }

        public static explicit operator byte[](BitField fld)
        {
            return fld.GetBits();
        }
        ...
        protected readonly int max_bits;
        ...
        /// </summary>
        public BitField() : this(8*255) { }

        public BitField(byte[] buffer) : this()
        {
            SetBits(buffer);
        }
        ...
        protected BitField(int bitBufferSize)
        {
            max_bits = bitBufferSize;
        }
