...
namespace STDFLib2
{
    public class Nibbles
    {
        ...
        public static explicit operator Nibbles(byte[] buffer)
        {
            return new Nibbles(buffer);
        }

        public static explicit operator byte[](Nibbles fld)
        {
        ...
        // Get the specified nibble.  Nibble is in the lower 4 bits of the returned byte, higher 4 bits are zero.
        ...
        public string ToString(int nibbleIndex)
        {
            char[] ns = new char[4];
